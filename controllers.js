...
Description:	: Mortgage Payment Calculator and Property Tax
                : 
Copyright       : GMedia-IT-Consulting 
email           : oleg_gorlov@yahoo.com
Date            : 10/05/2016
Release         : 1.0.0
Comment         : Implementation MVC, SPA, JQuery, JS, Bootstrup, AngularJS 1.5
...
angular
    ...
    .controller('ngJqGridController', ngJqGridController)
    .controller('angularBrokersController', angularBrokersController)
    .controller('angularListinersController', angularListinersController)
    .controller('angularCitiesController', angularCitiesController)

    .controller('MainCtrl_1', MainCtrl_1)
    .controller('MainCtrl', MainCtrl)

    .controller('aLandTransferTaxCalculator', aLandTransferTaxCalculator)
    .controller('aFinancialMortgageCalculator', aFinancialMortgageCalculator)
...
function aLandTransferTaxCalculator($scope) {

    this.Price = 0;
    this.Provincial = 0;
    this.Rebate = 0;
    this.Municipal = 0;
    this.totalLandTransferTax = 0;
    this.Marginal_Tax = 0;
    this.Marginal = 0;

    this.item_City_ = { code: 76, tax_City: 0.725, name: 'Toronto' };

    //this.item_City.name = 'Toronto';
    //this.item_City.tax_City = 0.725;
    //console.log("city :"+this.city.code[1]);

    $scope.cities =
    [
        { code: 1, tax_City: 0.725, name: 'Toronto' },
        { code: 2, tax_City: 0, name: 'Aurora' },
        { code: 3, tax_City: 0, name: 'Barrie' },
        { code: 4, tax_City: 0, name: 'Belleville' },
        { code: 5, tax_City: 0, name: 'Bradford' },
        { code: 6, tax_City: 0, name: 'Brampton' },
        { code: 7, tax_City: 0, name: 'Brant' },
        { code: 8, tax_City: 0, name: 'Brantford' },
        { code: 9, tax_City: 0, name: 'Brockville' },
        { code: 10, tax_City: 0, name: 'Burlington' },
        { code: 11, tax_City: 0, name: 'Cambridge' },
        { code: 12, tax_City: 0, name: 'Clarence-Rockland' },
        { code: 13, tax_City: 0, name: 'Cochrane' },
        { code: 14, tax_City: 0, name: 'Cornwall' },
        { code: 15, tax_City: 0, name: 'Dryden' },
        { code: 16, tax_City: 0, name: 'Durham' },
        { code: 17, tax_City: 0, name: 'Elgin' },
        { code: 18, tax_City: 0, name: 'Elliot Lake' },
        { code: 19, tax_City: 0, name: 'Essex' },
        { code: 20, tax_City: 0, name: 'Frontenac' },
        { code: 21, tax_City: 0, name: 'Greater Sudbury' },
        { code: 22, tax_City: 0, name: 'Grey' },
        { code: 23, tax_City: 0, name: 'Guelph' },
        { code: 24, tax_City: 0, name: 'Haldimand' },
        { code: 25, tax_City: 0, name: 'Haldimand County' },
        { code: 26, tax_City: 0, name: 'Halton' },
        { code: 27, tax_City: 0, name: 'Hamilton' },
        { code: 28, tax_City: 0, name: 'Hastings' },
        { code: 29, tax_City: 0, name: 'Kawartha Lakes' },
        { code: 30, tax_City: 0, name: 'Kenora' },
        { code: 31, tax_City: 0, name: 'King' },
        { code: 32, tax_City: 0, name: 'Kingston' },
        { code: 33, tax_City: 0, name: 'Kitchener' },
        { code: 34, tax_City: 0, name: 'Lambton' },
        { code: 35, tax_City: 0, name: 'Leeds and Grenville' },
        { code: 36, tax_City: 0, name: 'London' },
        { code: 37, tax_City: 0, name: 'Markham' },
        { code: 38, tax_City: 0, name: 'Middlesex' },
        { code: 39, tax_City: 0, name: 'Mississauga' },
        { code: 40, tax_City: 0, name: 'Newmarket' },
        { code: 41, tax_City: 0, name: 'Niagara' },
        { code: 42, tax_City: 0, name: 'Niagara Falls' },
        { code: 43, tax_City: 0, name: 'Nipissing' },
        { code: 44, tax_City: 0, name: 'Norfolk' },
        { code: 45, tax_City: 0, name: 'Norfolk County' },
        { code: 46, tax_City: 0, name: 'North Bay' },
        { code: 47, tax_City: 0, name: 'Orillia' },
        { code: 48, tax_City: 0, name: 'Oshawa' },
        { code: 49, tax_City: 0, name: 'Ottawa' },
        { code: 50, tax_City: 0, name: 'Owen Sound' },
        { code: 51, tax_City: 0, name: 'Oxford' },
        { code: 52, tax_City: 0, name: 'Peel' },
        { code: 53, tax_City: 0, name: 'Pembroke' },
        { code: 54, tax_City: 0, name: 'Perth' },
        { code: 55, tax_City: 0, name: 'Peterborough' },
        { code: 56, tax_City: 0, name: 'Pickering' },
        { code: 57, tax_City: 0, name: 'Port Colborne' },
        { code: 58, tax_City: 0, name: 'Prescott and Russell' },
        { code: 59, tax_City: 0, name: 'Prince Edward' },
        { code: 60, tax_City: 0, name: 'Prince Edward County' },
        { code: 61, tax_City: 0, name: 'Quinte West' },
        { code: 62, tax_City: 0, name: 'Renfrew' },
        { code: 63, tax_City: 0, name: 'Sarnia' },
        { code: 64, tax_City: 0, name: 'Sault Ste. Marie' },
        { code: 65, tax_City: 0, name: 'Simcoe' },
        { code: 66, tax_City: 0, name: 'St. Catharines' },
        { code: 67, tax_City: 0, name: 'St. Thomas' },
        { code: 68, tax_City: 0, name: 'Stormont' },
        { code: 69, tax_City: 0, name: 'Stratford' },
        { code: 70, tax_City: 0, name: 'Sudbury' },
        { code: 71, tax_City: 0, name: 'Temiskaming Shores' },
        { code: 72, tax_City: 0, name: 'Thorold' },
        { code: 73, tax_City: 0, name: 'Thunder Bay' },
        { code: 74, tax_City: 0, name: 'Timiskaming' },
        { code: 75, tax_City: 0, name: 'Timmins' },
        { code: 76, tax_City: 0.725, name: 'Toronto' },
        { code: 77, tax_City: 0, name: 'Vaughan' },
        { code: 78, tax_City: 0, name: 'Waterloo' },
        { code: 79, tax_City: 0, name: 'Welland' },
        { code: 80, tax_City: 0, name: 'Wellington' },
        { code: 81, tax_City: 0, name: 'Windsor' },
        { code: 82, tax_City: 0, name: 'Woodstock' },
        { code: 83, tax_City: 0, name: 'York' }
    ];

    this.item_Province;
    $scope.provinces =
    [
        { code: 1, tax_Province: 0.725, name: 'Ontario' },
        { code: 2, tax_Province: 0, name: 'Alberta' },
        { code: 3, tax_Province: 0.1, name: 'British Columbia' },
        { code: 4, tax_Province: 0.47, name: 'Manitoba' },
        { code: 5, tax_Province: 0.5, name: 'New Brunswick' },
        { code: 6, tax_Province: 0.498, name: 'Newfoundland' },
        { code: 7, tax_Province: 0.15, name: 'Northwest Territories' },
        { code: 8, tax_Province: 0, name: 'Nova Scotia' },
        { code: 9, tax_Province: 0, name: 'Nunavut' },
        { code: 10, tax_Province: 1, name: 'Prince Edward Island' },
        { code: 11, tax_Province: 0, name: 'Quebec' },
        { code: 12, tax_Province: 0, name: 'Saskatchewan' },
        { code: 13, tax_Province: 0, name: 'Yukon' }
    ];


    this.item_Marginal_Tax_Rate;
    $scope.marginal_taxs =
    [
        { code: 1, tax_Province: 0.5, name: '$55,000' },
        { code: 2, tax_Province: 1.0, name: 'On $55,000 to $250,000' },
        { code: 3, tax_Province: 1.5, name: 'On $250,000 to $400,000' },
        { code: 4, tax_Province: 2.0, name: 'Over $400,000' }

    ];

    //--- event for input and select tags
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            //console.log("i" +i+" Element: " + elements[i].tagName);
            //alert("Price" + Number(elements.val()))
        }
        function handleMouseOver(e) {
            e.target.style.background = "hsla(349, 100%, 84%, 0.62)";
    ...
    //var number_ = document.getElementById("number");
        ...
        for (var i = 0; i < elements2.length; i++) {
            ...
            elements2[i].onmouseover = handleMouseOver;
            elements2[i].onmouseout = handleMouseOut;
    ...
    this.updatePrice = function () {
        ...
        var elem = angular.element(document.querySelector('#Price'));
        //var elemTax = angular.element(document.querySelector('#tax'));

    }

    this.Checkbox_Rebate =
    {
        value2: 'No'
    };

    this.change_Checkbox_Rebate = function () {

        //slideYesNo
        console.log('#Checkbox_Rebate .... : ' + this.Checkbox_Rebate.value2);
        if (this.Checkbox_Rebate.value2 == 'Yes') {
            this.Rebate = 2000;
            console.log('#Rebate Yes ... : ' + this.Rebate);
        }
        else {
            this.Rebate = 0;
            console.log('#Rebate .... : ' + this.Rebate);
        }
        console.log('#Rebate No.... : ' + this.Rebate);
    }

    this.calculate = function Calculate() {

        var elem = angular.element(document.querySelector('#Price'));
        //var city_ = angular.element(document.querySelector('#item_City.tax_City'));

        //--- Provincial Ontario land transfer tax1
        if (this.Price < 55000) {
            this.Marginal = (this.Price / 100) * 0.5;
            this.Marginal_Tax = 0.5;
        }

        if (this.Price > 55000 && this.Price < 250000) {
            this.Marginal = (this.Price / 100) * 1;
            this.Marginal_Tax = 1;
        }

        if (this.Price > 250000 && this.Price < 400000) {
            this.Marginal = (this.Price / 100) * 1.5;
            this.Marginal_Tax = 1.5;
        }

        if (this.Price > 400000) {
            this.Marginal = (this.Price / 100) * 2;
            this.Marginal_Tax = 2.0;
        }

        //--- totalLandTransferTax 

        //console.log("selectedCity $ : " + this.selectedCity);
        console.log("Rebate $ : " + this.Rebate);
        //console.log("Municipal $ : " + (this.Price/100)*this.item_City.tax_City);
        console.log("Provincial $ : " + this.Provincial);

        console.log("calculate Marginal ....................... :");

        console.log("Price $ : " + this.Price);
        console.log("Marginal $ : " + this.Marginal);
        console.log("Marginal_Tax $ : " + this.Marginal_Tax);
        console.log('#tax ... : ' + this.tax);
        console.log("totalLandTransferTax $ : " + this.totalLandTransferTax);
    };




    /*--- Page 23 http://www.slideshare.net/proshailendra/angular-js-interview-questions-answers-by-shailendra-chauhan   ---*/

    this.msg = 'wwwroot/js/MainCtrl';
    console.log(this.msg);

    /*--- Page 16 http://www.slideshare.net/proshailendra/angular-js-interview-questions-answers-by-shailendra-chauhan   ---*/
...
function aFinancialMortgageCalculator($scope) {
    ...
    /**
    * period_payment - Data used Form view for Morgrige Calculator 
    * controller WebAPI - aFinancialController.cs 
    * view - aFinancialMortgageCalculator.cshtml
    * 
    */

    this.Loan = 400000;
    this.Bank_Interest_Rate = 2.64;
    this.Loan_Term = 30;
    this.First_Payment_Date;
    this.Last_Payment_Date = this.First_Payment_Date;
...
30
    ...
    this.curPayment = 'Monthly';

    this.payments = ['Monthly', 'Bimonthly'];

    this.period_payments = {
        Monthly: 12,
        Bimonthly: 6
    };
    ...
    //var item = this.db.item;

    //console.log(item);
    //item.date = $filter('date')(item.date, "dd/MM/yyyy");

    var dateAsDate = new Date();

    //this.item = $filter('date')(dateAsDate, "dd/MM/yyyy");
    ...
    this.calculate = function Calculate() {
        ...
        this.N = this.Loan_Term * this.period_payments[this.curPayment];

        this.I = (this.Bank_Interest_Rate / 100) / this.period_payments[this.curPayment];

        this.v = Math.pow((1 + this.I), this.N);

        this.t = (this.I * this.v) / (this.v - 1);


        //var elem = angular.element(document.querySelector('#curLoan_balance'));

        //this.result = elem.val() * this.t;

        var elem = angular.element(document.querySelector('#Loan'));

        this.monthly_payment = this.Loan * this.t;
        ...
        console.log("vm.currentTime : " + vm.currentTime);

        console.log("First_Payment_Date 1 : " + this.First_Payment_Date);

        console.log("Loan_Term year : " + this.Loan_Term);
        console.log("Last Payment 1 : " + this.Loan_Term * 365);

        this.Last_Payment_Date = this.First_Payment_Date.setDate(this.First_Payment_Date.getDate() + this.Loan_Term * 365);

        console.log("Last_Payment_Date 2 : " + this.Last_Payment_Date);

        //this.Last_Payment_Date = this.First_Payment_Date.setYear(this.First_Payment_Date.getFullYear() + this.Loan_Term);

        console.log("Last_Payment_Date 3 : " + this.Last_Payment_Date);

        console.log("Loan $ : " + this.Loan);

        console.log("curPayment  : " + this.curPayment);
        console.log("N : " + this.N);
        console.log("I : " + this.I);

        console.log("v :" + this.v);
        console.log("t : " + this.t);
        console.log("monthly_payment $ : " + this.monthly_payment);


        console.log('#Loan $ : ' + elem.val());
        console.log("First_Payment_Date : " + this.First_Payment_Date);
        console.log("Last_Payment_Date : " + this.Last_Payment_Date);

        //window.alert("Calculate Done." + this.result);
    };
    ...
    this.updatePrice = function () {
        ...
        //console.log('#tax elemTax.val()... : ' + elemTax.val());
        console.log('#Price elem.val().... : ' + elem.val());
    }
...
function ngJqGridController($scope)
    //function ngJqGridController($scope, config, data) 
{

    this.msg = 'ngJqGridController';
    console.log(this.msg);
                ...
                return {
                    ...
                    link: function (scope, element, attrs) {
                        ...
                        scope.$watch('data', function (newValue, oldValue) {
                            var p = $(table).jqGrid("getGridParam");
                            p.data = newValue;
    ...
    */
    //myApp.controller('ngJqGridController', function ($scope) {

    $scope.config = {

        url: "/jpGridAddress/GetReport",
        datatype: 'json',
        page: 1,
        mtype: 'Get',
        ...
        colModel: [
                { name: 'id', width: 60, template: "integer" },
                {
                    name: 'invdate', width: 90, align: "center",
                    formatter: "date", formatoptions: { newformat: "d-M-Y" }, sorttype: "date"
                },
                { name: 'name', width: 100 },
                { name: 'amount', width: 80, template: "number" },
                { name: 'tax', width: 80, template: "number" },
                { name: 'total', width: 80, template: "number" },
    ...
    $scope.data = [
               { id: "10", invdate: "2007-10-01", name: "test1", note: "note1", amount: "", tax: "", closed: true, ship_via: "TN", total: "" },
    ...
    console.log($scope.config.iconSet);
...
function angularBrokersController($scope, Broker) {
    //$scope.title = 'angularListinerController';
    //activate();
    //function activate() { }
    $scope.Broker = Broker.APIData();

    this.msg = 'wwwroot/js/controller.js angularBrokersController';
    console.log(this.msg);
}

function angularListinersController($scope, Listiner) {
    //$scope.title = 'angularListinerController';
    //activate();
    //function activate() { }
    $scope.Listiner = Listiner.APIData();

    this.msg = 'wwwroot/js/controller.js angularListinersController';
    console.log(this.msg);
}

function angularCitiesController($scope, City) {
    //$scope.title = 'angularListinerController';
    //activate();
    //function activate() { }
    $scope.City = City.APIData();

    this.msg = 'wwwroot/js/controller.js angularCitiesController';
    console.log(this.msg);
}
...
function chartJsCtrl() {
    ...
    console.log("this.lineData : " + this.lineData.labels[1]);
    //console.log("this.polarData : " + this.polarData);
    ...
    console.log("polarData : " + this.polarData);
